...
try:
    ...
    class api:
        ...
        class config:
            ...
            version = "0.0.1"
            operator_description = "Topic Frequency"
            operator_description_long = "Find frequency of topics in keyword index."
            add_readme = dict()
...
def process(db_msg):
    ...
    logger, log_stream = slog.set_logging('topic_frequency', loglevel=api.config.debug_mode)
